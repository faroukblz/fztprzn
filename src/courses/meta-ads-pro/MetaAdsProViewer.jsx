...
import Slide1_BMHierarchy from './slides/Slide1_BMHierarchy';
import Slide2_HouseTheory from './slides/Slide2_HouseTheory';
import Slide3_AlgerianMarket from './slides/Slide3_AlgerianMarket';
import Slide4_AndromedaStrategy from './slides/Slide4_AndromedaStrategy';
import Slide5_MatrixDashboard from './slides/Slide5_MatrixDashboard';

const slides = [
  { id: 1, component: Slide1_BMHierarchy, title: 'مدير الأعمال' },
  { id: 2, component: Slide2_HouseTheory, title: 'نظرية المنزل' },
  { id: 3, component: Slide3_AlgerianMarket, title: 'السوق الجزائري' },
  { id: 4, component: Slide4_AndromedaStrategy, title: 'أندروميدا' },
  { id: 5, component: Slide5_MatrixDashboard, title: 'المقاييس' },
];
...
export default function MetaAdsProViewer() {
    ...
    <div className="relative w-full h-screen overflow-hidden noise-overlay" style={{ backgroundImage: 'url(/bg-gradient.png)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
      ...
      <div className="absolute top-0 left-0 right-0 z-50 flex items-center justify-between px-8 py-4">
        ...
        <div className="flex items-center gap-3">
          <span className="text-white/30 text-xs font-medium tracking-wider">احتراف إعلانات ميتا</span>
